defmodule LeydenJar.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  ...
  schema "users_tokens" do
    ...
    belongs_to :user, LeydenJar.Accounts.User
  ...
  def user_and_contexts_query(user, [_ | _] = contexts) do
    from t in LeydenJar.Accounts.UserToken, where: t.user_id == ^user.id and t.context in ^contexts
  end
end
