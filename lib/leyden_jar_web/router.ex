defmodule LeydenJarWeb.Router do
  use LeydenJarWeb, :router

  import LeydenJarWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {LeydenJarWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: LeydenJarWeb.Telemetry
    end
  end
